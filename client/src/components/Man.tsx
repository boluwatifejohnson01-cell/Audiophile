...
const manDesk =
  "https://res.cloudinary.com/drdr9gib1/image/upload/v1780917992/manDesktop_jbpzj0.png";

const manMob =
  "https://res.cloudinary.com/drdr9gib1/image/upload/v1780918004/manMobile_fxva5j.png";
    ...
    <section className="px-6 sm:px-[clamp(1rem,11.40vw,200px)] my-24 md:my-32 lg:my-40">
      <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-31.25">
        <div className="order-2 lg:order-1 flex flex-col items-center lg:items-start text-center lg:text-left gap-8 max-w-111.25">
          <h2 className="font-bold text-[28px] md:text-[40px] leading-tight tracking-[1.15px] md:tracking-[1.43px] uppercase text-black">
        ...
        <div className="order-1 lg:order-2 w-full lg:w-auto lg:shrink-0">
          <img src={manDesk} alt="" className="w-full hidden lg:block" />
          <img src={manMob} alt="" className="lg:hidden" />
        </div>
      </div>
    </section>
  );
